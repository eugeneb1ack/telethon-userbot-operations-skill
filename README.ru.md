...
1. Проверить локальный registry и использовать готовый gateway-маршрут или модуль, если он уже решает задачу.
...
6. Запустить `scripts/check_module.py modules/<name>.py --full`. Использовать можно только модуль, прошедший полный gate.
